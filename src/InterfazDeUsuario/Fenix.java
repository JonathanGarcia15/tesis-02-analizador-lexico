...
public class Fenix extends JFrame{
    ...
    public Fenix(){
        ...
        recompilarLexico.addActionListener(e -> {
            //Compilador del Lexico
            CompiladorLenguajeUsuario compilador = new CompiladorLenguajeUsuario();
            compilador.GenerarAnalizadorLexico();
        });

        //Este método se ejecuta cuando solo se requiere el Análisis Léxico del código fuente:
        compilar.addActionListener(e -> {
            //Guardando en un String el código fuente:
            String ProgramaFuente = txtCodigoFuente.getText();
            //En este objeto se guardará el resultado del Analisis Léxico:
            JSONObject resultado;
            //Ejecutando el Analisis Léxico:
            resultado = Analizadores.AnalizarSoloLexico(ProgramaFuente,"");
